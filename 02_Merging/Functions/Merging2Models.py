def Merging2Models(Model1, Model2, MergedModel, Folder_Main, Folder_Temporary, Folder_Merging_Functions,
    ...
    # CSVSequencing(CSV1,"",Folder_Temporary, Folder_Merging_Functions,
    #               Folder_Merging_Sequencing, Folder_Merging_Create_x_file)
    # CSVSequencing(CSV2,"",Folder_Temporary, Folder_Merging_Functions,
    #               Folder_Merging_Sequencing, Folder_Merging_Create_x_file)

    # Merging 2 CSV in a 3rd one with name of it. Nothing more
    CSV3 = Merging2CSV(CSV1, CSV2, MergedModel, Folder_Main, Folder_Temporary, Folder_Merging_Functions,
                       Folder_Merging_Sequencing, Folder_Merging_Create_x_file)
